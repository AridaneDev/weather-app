...
function App() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col bg-cover bg-center bg-transition relative"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col justify-center p-6 gap-6">
          <div className="flex justify-center">
            <SearchBar onSearch={fetchWeather} />
          </div>

          {weather && (
            <p className="text-white text-4xl font-semibold text-center drop-shadow mb-8 flex items-center justify-center gap-2">
          ...
          {weather && !loading && (
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
              ...
              <div className="text-white drop-shadow-lg text-center md:text-left">
                <p className="text-7xl md:text-9xl font-bold leading-none mb-3">
